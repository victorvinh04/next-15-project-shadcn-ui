...
import { ProductsTable } from '@/app/(examples)/dashboard-03/components/product-table';
import { DownloadIcon, FilterIcon, TrendingDownIcon, TrendingUpIcon } from 'lucide-react';
import { Metadata } from 'next';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Card, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/ui/cards/card';
