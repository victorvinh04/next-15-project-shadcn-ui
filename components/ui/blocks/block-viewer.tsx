...
type BlockViewerContext = {
  ...
  highlightedFiles:
    | (z.infer<typeof registryItemSchema> & { highlightedContent: string })[]
    | null
  iframeKey?: number
  ...
  return (
    <BlockViewerContext.Provider
      value={{
        ...
        view,
        setView,
        resizablePanelRef: resizeablePanelRef,
        activeFile,
        setActiveFile,
        tree,
        highlightedFiles,
  ...
  return (
    <div className='hidden group-data-[view=code]/block-view-wrapper:hidden md:h-(--height) lg:flex'>
      <div className='relative grid w-full gap-4'>
        <div className='insert-0 absolute right-4 [background-image:radial-gradient(#d4d4d4_1px,transparent_1px)] [background-size:20px_20px] dark:[background-image:radial-gradient(#404040_1px,transparent_1px)]'></div>
        <ResizablePanelGroup
        ...
        >
          ...
          <ResizableHandle className='after:bg-border relative hidden w-3 bg-transparent p-3 after:absolute after:top-1/2 after:right-0 after:h-8 after:w-[6px] after:translate-x-[-1px] after:-translate-y-1/2 after:rounded-full after:transition-all after:hover:h-10 md:block' />
...
//   return (
//     <div className="bg-code text-code-foreground mr-[14px] flex overflow-hidden rounded-xl border group-data-[view=preivew]/block-view-wrapper:hidden md:h-(height)">
//       <div className="w-72">
//         <BlockViewerFileTree />
//       </div>
//       <figure
